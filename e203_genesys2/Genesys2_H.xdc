...
# Clock Signal
set_property -dict { PACKAGE_PIN AD11  IOSTANDARD LVDS     } [get_ports { CLK200M_n }]; #IO_L12N_T1_MRCC_33 Sch=sysclk_n
set_property -dict { PACKAGE_PIN AD12  IOSTANDARD LVDS     } [get_ports { CLK200M_p }]; #IO_L12P_T1_MRCC_33 Sch=sysclk_p

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets u1_clk_wiz/inst/clkin1_ibufgds]
...
set_property -dict {PACKAGE_PIN U30 IOSTANDARD LVCMOS33} [get_ports {led[0]}]
set_property -dict {PACKAGE_PIN U29 IOSTANDARD LVCMOS33} [get_ports {led[1]}]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports {led[2]}]
set_property -dict {PACKAGE_PIN V26 IOSTANDARD LVCMOS33} [get_ports {led[3]}]
set_property -dict {PACKAGE_PIN W24 IOSTANDARD LVCMOS33} [get_ports {led[4]}]
set_property -dict {PACKAGE_PIN W23 IOSTANDARD LVCMOS33} [get_ports led_singal]

##### PMU define ##### 
set_property -dict { PACKAGE_PIN T28 IOSTANDARD LVCMOS33 } [get_ports pmu_paden ]; #pmu_paden=led[0] 
set_property -dict { PACKAGE_PIN V19 IOSTANDARD LVCMOS33 } [get_ports pmu_padrst]; #pmu_padrsth=led[1] 
set_property -dict { PACKAGE_PIN P27 IOSTANDARD LVCMOS33 } [get_ports mcu_wakeup]; #mcu_wakeup Sch=sw[7]
...
##### MCU JTAG define: ##### 
set_property -dict { PACKAGE_PIN W21 IOSTANDARD LVCMOS33 } [get_ports mcu_TCK]; #jd[10] = mcu_TCK 
set_property -dict { PACKAGE_PIN V22 IOSTANDARD LVCMOS33 } [get_ports mcu_TDO]; #jd[9] = mcu_TDO 
set_property -dict { PACKAGE_PIN Y26 IOSTANDARD LVCMOS33 } [get_ports mcu_TMS]; #jd[8] = mcu_TMS 
set_property -dict { PACKAGE_PIN U24 IOSTANDARD LVCMOS33 } [get_ports mcu_TDI]; #jd[7] = mcu_TDI 
set_property KEEPER true [get_ports mcu_TMS] 
##### UART define: ##### 
# set_property -dict { PACKAGE_PIN W22 IOSTANDARD LVCMOS33 } [get_ports {gpioA[16]}]; #jd[4] = UART_RX 
# set_property -dict { PACKAGE_PIN V24 IOSTANDARD LVCMOS33 } [get_ports {gpioA[17]}]; #jd[3]= UART_TX
set_property -dict { PACKAGE_PIN W22 IOSTANDARD LVCMOS33 } [get_ports uart0_rx]; #jd[4] = UART_RX 
set_property -dict { PACKAGE_PIN V24 IOSTANDARD LVCMOS33 } [get_ports uart0_tx]; #jd[3]= UART_TX
...
set_property -dict { PACKAGE_PIN P24 IOSTANDARD LVCMOS33 } [get_ports {qspi0_dq[0]}]; 
set_property -dict { PACKAGE_PIN R25 IOSTANDARD LVCMOS33 } [get_ports {qspi0_dq[1]}]; 
set_property -dict { PACKAGE_PIN R20 IOSTANDARD LVCMOS33 } [get_ports {qspi0_dq[2]}]; 
