...
##### PMU define ##### 
# set_property -dict { PACKAGE_PIN T28 IOSTANDARD LVCMOS33 } [get_ports pmu_paden_0 ]; #pmu_paden=led[0] 
# set_property -dict { PACKAGE_PIN V19 IOSTANDARD LVCMOS33 } [get_ports pmu_padrst_0]; #pmu_padrsth=led[1] 
